...
is that for the first, we say there is an individual for all inviduals such that that everyone likes someone, and that someone \ti{can} be unique to everyone.
